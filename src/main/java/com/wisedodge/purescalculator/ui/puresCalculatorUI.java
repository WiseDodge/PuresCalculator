...
public class puresCalculatorUI {
  ...
  private void initializeUI() {
    ...
    calculateButton.setOnAction(e -> {
      try {
        ...
        if (conversionType.equals("PB to Vile")) {
          result = new com.wisedodge.purescalculator.converters.pbToVileConverter().convert(quantity);
        } else if (conversionType.equals("Vile to PB")) {
          result = new com.wisedodge.purescalculator.converters.vileToPbConverter().convert(quantity);
        } else {
    ...
    lookupPlayerButton.setOnAction(e -> com.wisedodge.purescalculator.lookupmodule.playerLookupUI.openPlayerLookupScreen());
