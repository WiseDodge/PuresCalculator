...
public class pbToVileConverter {
  ...
  public String convert(double quantity) {
    ...
    com.wisedodge.purescalculator.logging.devLogger.logPbToVile("Converted %.1f PB to %.0f Vile.%n", quantity, totalVile);

    StringBuilder result = new StringBuilder(String.format("%.1f PB is equivalent to %.0f Vile.",
            quantity, totalVile));
