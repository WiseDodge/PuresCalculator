...
public class vileToPbConverter {
  ...
  public String convert(double quantity) {
    ...
    com.wisedodge.purescalculator.logging.devLogger.logVileToPb("Converted %.0f Vile to %.1f PB.%n", quantity, totalPb);

    StringBuilder result = new StringBuilder(String.format("%.0f Vile is equivalent to %.1f PB.",
            quantity, totalPb));
